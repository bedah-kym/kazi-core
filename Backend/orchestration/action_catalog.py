...
ACTION_CATALOG: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "aliases": ["remind"],
        "service": "reminder",
        "description": "Create a scheduled reminder that will notify the user at the specified time. Delivery can be chosen at creation: 'auto' (delivered in chat when the user is online, otherwise Telegram if connected, otherwise email), 'email', 'whatsapp', or 'in_app'.",
        "params": {
            ...
            "delivery": {"type": "string", "required": False, "description": "Delivery channel: 'auto' (default), 'in_app', 'email', or 'whatsapp'"},
            "urgent": {"type": "boolean", "required": False, "description": "Set true when the user must not miss this (exam, meeting, flight, deadline). Forces email delivery with retries."},
        },
    ...
    },
    {
        ...
        "aliases": ["reminders", "upcoming_reminders", "show_reminders"],
        "service": "reminder",
        "description": "List the user's scheduled reminders (upcoming, past, failed) with their delivery channel and status. Always use this tool to check reminders — never search notes or memory.",
        "params": {},
        "return_description": "Returns reminders with id, content, scheduled time, delivery channel, priority, and status",
        "risk_level": "low",
        "confirmation_policy": "never",
        "capability_gate": "allow_reminders",
    },
    {
        ...
        "description": "List the user's recent in-app notifications with read state. Always use this tool to check notifications — never search notes or memory.",
        "params": {},
        "return_description": "Returns notifications with id, event type, title, body, severity, and read state",
        "risk_level": "low",
        "confirmation_policy": "never",
